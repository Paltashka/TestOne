...
export function auth(email, password, isLogin){
    return async dispatch => {
        ...
        let url = 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAXzAdX8t8sXSMxj-VQaM4u1NC2gKmq9wY'

        if (isLogin){
            url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAXzAdX8t8sXSMxj-VQaM4u1NC2gKmq9wY'
        }
